...
<div class="container">
    <div class="panel panel-info col-md-6 col-md-offset-3" style="margin-top: 5%">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo e(route('post.updatePost')); ?>">
                ...
                <div class="form-group">
                    <label>Tag:</label>
                    <input type="text" name="tag" class="form-control" value="<?php echo e($post['tag']); ?>">
                </div>
                <div class="form-group">
                    <label>Description:</label>
                    <textarea class="form-control" name="description"><?php echo e($post['description']); ?></textarea>
                </div>
